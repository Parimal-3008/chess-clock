...
function MOVE() {
     let p1 = document.getElementById("time");
     if (document.getElementById("WIT").value.trim().length == 0 || document.getElementById("WIncT").value .trim().length == 0  || document.getElementById("BIT").value .trim().length == 0 || document.getElementById("BIncT").value.trim().length == 0 ) {
